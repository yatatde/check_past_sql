-- The pupose of query  - to review existing grantees previlegious for set of tables 
-- against grantees privilegious allowed. 
...
-- The review report has format like csv and can be imported to MS EXEL  
WITH 
TABLES_TO_CHECK
